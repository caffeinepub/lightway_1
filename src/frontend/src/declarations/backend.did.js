...
export const idlService = IDL.Service({
  ...
  'fetchPrayerTimes' : IDL.Func([IDL.Text], [IDL.Text], []),
  'fetchQuranVerse' : IDL.Func([IDL.Nat, IDL.Nat], [IDL.Text], []),
  'getBook' : IDL.Func([IDL.Text], [Book], ['query']),
  'getCallerUserProfile' : IDL.Func([], [IDL.Opt(UserProfile)], ['query']),
  'getCallerUserRole' : IDL.Func([], [UserRole], ['query']),
  'getPrayerSearchCount' : IDL.Func([], [IDL.Nat], ['query']),
  'getQuranSearchCount' : IDL.Func([], [IDL.Nat], ['query']),
